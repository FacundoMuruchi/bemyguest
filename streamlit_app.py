...
def main():
    ...
    explore_tab, create_tab, seed_tab, neo4j_tab, neo4j_seed_tab, admin_tab = st.tabs(
        ["Explorar datos", "Registrar documento", "Cargar datos", "Recomendaciones (Neo4j)", "Cargar datos Neo4j", "Administrar"]
    )
